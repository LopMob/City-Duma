...
from app.routers import commissions, deputies
...
# NB: роутеры для членства в комиссиях (задача #2) и заседаний/посещаемости
# (задача #3) подключаются здесь же по мере готовности, см. docs/tasks/.
